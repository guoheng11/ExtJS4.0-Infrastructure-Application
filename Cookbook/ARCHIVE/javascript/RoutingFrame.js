RoutingFrame = Ext.extend(Ext.Panel, {
	projectId: '',
	routingGrid:'',
    ...
    initComponent:function() {
	    ...
	    var eto = this;
		this.routingGrid = new RoutingGrid(this.projectId);
	    Ext.apply(this, {
		    closable:true,
		    bodyStyle: 'padding:10 10;',
            baseCls: 'cookBackground',
            title:'Routing',
	        items: [this.routingGrid]
		});
    	
		RoutingFrame.superclass.initComponent.call(this);
    },
    
    constructor: function(tabCont,projId) {
		this.projectId = projId;
		RoutingFrame.superclass.constructor.call(this);
    }
});

RoutingGrid = Ext.extend(Ext.grid.EditorGridPanel, {
	projectId: '',
	removeRouteButton: '',
	...
	initComponent:function() {
	    ...
	    this.on('celldblclick', function(grid, rowIndex, columnIndex, e) {
		    ...
		    if(fieldName == "new_division" || fieldName == "new_product" || fieldName == "new_dnis" || fieldName == "consolidation") {
