Ext.define('CookBook.view.requirements.ViewReqFaxForm', {
    extend: 'Ext.grid.Panel',
    alias: 'widget.viewReqFaxForm',
    ...
    columns: [{
        ...
        items: [{
            ...
            handler: function(grid, rowIndex, colIndex) {
                ...
                grid.getStore().getAt(rowIndex).set('filename', rec + '.tif');
            }
        }]
    }, {
        header: '.tif/.map File',
