Ext.define('CookBook.view.requirements.ViewReqGrammar', {
    extend: 'Ext.grid.Panel',
    alias: 'widget.viewReqGrammar',

    title: 'Grammar',
    //collapsible: true,
    //collapseFirst: true,
    collapsed: true,
    store: 'GrammarRequirements',
    ...
    columns: [{
        ...
        items: [{
            ...
            handler: function(grid, rowIndex, colIndex) {
                ...
                grid.getStore().getAt(rowIndex).set('filename', rec + '.abnf');
            }
        }]
    }, {
        header: '.abnf/.grxml/.tar/.tar.gz File',
        dataIndex: 'filename',
        flex: 1,
        editor: {
            xtype: 'combobox',
