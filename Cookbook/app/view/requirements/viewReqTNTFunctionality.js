Ext.define('CookBook.view.requirements.ViewReqTNTFunctionality', {
    extend: 'Ext.grid.Panel',
    alias: 'widget.viewReqTNTFunctionality',

    title: 'TNT Functionality',
    //collapsible: true,
    //collapseFirst: true,
    collapsed: true,

    store: 'TNTFunctionalityRequirements',
