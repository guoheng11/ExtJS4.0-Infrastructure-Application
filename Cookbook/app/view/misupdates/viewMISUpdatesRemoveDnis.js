Ext.define('CookBook.view.misupdates.ViewMISUpdatesRemoveDnis', {
	extend: 'Ext.grid.Panel',
	alias:  'widget.viewMISUpdatesRemoveDnis',

	name: 'misupdatesRemoveDnis',
	...
	store: 'MISUpdateRemoveDnises',
	/*store: {
		fields: ['dnis','remove_from','platform','description','effective_date'],
		data: [ ]
	},*/
	columns: [
