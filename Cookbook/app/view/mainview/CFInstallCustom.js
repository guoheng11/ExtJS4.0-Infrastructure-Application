Ext.define('CookBook.view.mainview.CFInstallCustom', {});

// Copyright (c) 2009 The Chromium Authors. All rights reserved.
// Use of this source code is governed by a BSD-style license that can be
// found in the LICENSE file.

//MODIFIED BY ADAM HAMMAD (ah) - disable close button and cookie
...
(function(scope){
     ...
     */
    var offlineInstall = function(){
        //alert("You are going to be prompted to install GoogleChromeframeStandaloneEnterprise.msi.  After the install, it will take several minutes to configure.");
        window.open("app/GoogleChromeframeStandaloneEnterprise.msi", '_blank'); 
    }
    ...
    var makeOverlayPrompt = function(args){
        ...
        // ah - removing close button '<button id="chromeFrameCloseButton">close</button>' +
        '<button id="offlineInstallButton">Offline Install</button>' +
        '</td>' +
        '</tr>' +
        '<tr>' +
        ...
        byId('offlineInstallButton').onclick = offlineInstall;
    };
    ...
    CFInstall.check = function(args){
        ...
        /*
         * disabled ah - this is so the overlay is not auto closed
         *
