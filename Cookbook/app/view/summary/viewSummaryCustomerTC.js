Ext.define('CookBook.view.summary.ViewSummaryCustomerTC', {
    extend: 'Ext.form.field.ComboBox',
    alias: 'widget.viewSummaryCustomerTC',
    
    store: 'Contacts',
    
    //options
    fieldLabel: 'Customer TC',
    labelAlign: 'top',
    trigerAction: 'all',
    typeAhead: false,
    displayField: 'name',
    ...
    name: 'summaryCustomerTC',
    
    listeners: {
        render: function(c){
            Ext.QuickTips.register({
                target: c.getEl(),
                text: 'Select a Customer Team Coordinator'
            });
        },
        expand: function(){
