Ext.define('CookBook.view.summary.ViewSummaryCustomerRFQ', {
    extend: 'Ext.form.field.ComboBox',
    alias: 'widget.viewSummaryCustomerRFQ',
    ...
    queryMode: 'local',
    lastQuery: '',
    name: 'summaryCustomerRFQ',
    
    listeners: {
        render: function(c){
            Ext.QuickTips.register({
                target: c.getEl(),
                text: 'Select a Customer contact'
            });
        },
        expand: function(){
        ...
        collapse: function(){
            //console.log('collapsing; clearing filter');
            this.store.clearFilter();
        }
        /*,
         expand: function(c, options) {
         var store = c.getStore();
         store.proxy.extraParams.primary_type = 7;
         store.load();
         }*/
    }
});
