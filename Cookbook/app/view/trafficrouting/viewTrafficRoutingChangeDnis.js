Ext.define('CookBook.view.trafficrouting.ViewTrafficRoutingChangeDnis', {
    extend: 'Ext.grid.Panel',
    alias: 'widget.viewTrafficRoutingChangeDnis',
    
    name: 'trafficroutingChangeDnis',
    ...
    store: 'TrafficRoutingChangeDnises',
    columns: [{
